...
public class QuizRequest2 {
	...
	private List<QuestionDTO2> questions;
	public QuizRequest2(int quizId, String name, String description, double duration, int questionCount,
			double passingMark, List<QuestionDTO2> questionDTOs) {
		super();
		this.quizId = quizId;
		this.name = name;
	...
	public List<QuestionDTO2> getQuestions() {
		return questions;
	}
	public void setQuestions(List<QuestionDTO2> questionDTOs) {
		this.questions = questionDTOs;
	}
	@Override
