...
//		byte[] imageBytes = Files.readAllBytes(Paths.get("C:\\Users\\shirl\\Desktop\\against.jpg"));
		...
		Question javaBq1 = questionService.createNewQuestion(javaBeginner, "Question Content",
				Question.QuestionType.MUTIPLE_CHOICE, 4, null);
		...
		Question javaBq2 = questionService.createNewQuestion(javaBeginner, "Question Content",
				Question.QuestionType.MULTI_SELECT, 4, null);
