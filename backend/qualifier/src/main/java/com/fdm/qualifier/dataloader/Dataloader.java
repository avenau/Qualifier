...
//		byte[] imageBytes = Files.readAllBytes(Paths.get("C:\\Users\\shirl\\Desktop\\against.jpg"));		
		...
		Question javaBq2 = questionService.createNewQuestion(javaBeginner, "Q 2 - What is TreeSet Interface?", Question.QuestionType.MUTIPLE_CHOICE, 5, null);
		...
		Question javaBq3 = questionService.createNewQuestion(javaBeginner, "Q 3 - Method Overriding is an example of", Question.QuestionType.MUTIPLE_CHOICE, 5, null);
		...
		Question javaBq4 = questionService.createNewQuestion(javaBeginner, "Q 4 - What is synchronization?", Question.QuestionType.MUTIPLE_CHOICE, 5, null);
		...
		Question javaBq5 = questionService.createNewQuestion(javaBeginner, "Q 5 - This is the parent of Error and Exception classes.", Question.QuestionType.MUTIPLE_CHOICE, 5, null);
		...
		Question javaBq6 = questionService.createNewQuestion(javaBeginner, "Q 6 - Inheritance", Question.QuestionType.MUTIPLE_CHOICE, 5, null);
		...
		Question javaBq7 = questionService.createNewQuestion(javaBeginner, "Q 7 - The thread may be in", Question.QuestionType.MUTIPLE_CHOICE, 5, null);
		...
		Question javaBq8 = questionService.createNewQuestion(javaBeginner, "Q 8 - The correct statement from the following is/are", Question.QuestionType.MUTIPLE_CHOICE, 5, null);
		...
		Question javaBq9 = questionService.createNewQuestion(javaBeginner, "Q 9 - The methods wait ( ) and notify ( ) are defined in", Question.QuestionType.MUTIPLE_CHOICE, 5, null);
		...
		Question javaBq10 = questionService.createNewQuestion(javaBeginner, "Q 10 - For the method that does not return a value, the keyword used is", Question.QuestionType.MUTIPLE_CHOICE, 5, null);
		...
		Question javaBq11 = questionService.createNewQuestion(javaBeginner, "Q 11 - Which one of the following is not a wrap class?", Question.QuestionType.MUTIPLE_CHOICE, 5, null);
		...
		Question javaBq12 = questionService.createNewQuestion(javaBeginner, "Q 12 - Object oriented programming language, is", Question.QuestionType.MUTIPLE_CHOICE, 5, null);
		...
		Question javaBq13 = questionService.createNewQuestion(javaBeginner, "Q 13 - ?: is: a/an", Question.QuestionType.MUTIPLE_CHOICE, 5, null);
		...
		Question javaBq14 = questionService.createNewQuestion(javaBeginner, "Q 14 - Which of the below is valid way to instantiate an array in java?", Question.QuestionType.MUTIPLE_CHOICE, 5, null);
		...
		Question javaBq15 = questionService.createNewQuestion(javaBeginner, "Q 15 - What are the valid statements for static keyword in Java?", Question.QuestionType.MULTI_SELECT, 5, null);
		...
		Question javaBq16 = questionService.createNewQuestion(javaBeginner, "Q 16 - Which of the below are unchecked exceptions in java?", Question.QuestionType.MULTI_SELECT, 5, null);
		...
		Question javaBq17 = questionService.createNewQuestion(javaBeginner, "Q 17 - Which of the following statement(s) are true for java?", Question.QuestionType.MULTI_SELECT, 5, null);
		...
		Question javaBq18 = questionService.createNewQuestion(javaBeginner, "Q 18 - Which of the following statements are true about Enum in java?", Question.QuestionType.MULTI_SELECT, 5, null);
		...
		Question javaBq19 = questionService.createNewQuestion(javaBeginner, "Q 19 - Which of the below are built-in class loaders in java?", Question.QuestionType.MULTI_SELECT, 5, null);
		...
		Question javaBq20 = questionService.createNewQuestion(javaBeginner, "Q 20 - Which of the following statements are true about annotations in java?", Question.QuestionType.MULTI_SELECT, 5, null);
