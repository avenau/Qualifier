...
//		byte[] imageBytes = Files.readAllBytes(Paths.get("C:\\Users\\shirl\\Desktop\\against.jpg"));		
		...
		Question javaBq2 = questionService.createNewQuestion(javaBeginner, "Q 2 - What is TreeSet Interface?", Question.QuestionType.MULTIPLE_CHOICE, 5);
		...
		Question javaBq3 = questionService.createNewQuestion(javaBeginner, "Q 3 - Method Overriding is an example of", Question.QuestionType.MULTIPLE_CHOICE, 5);
		...
		Question javaBq4 = questionService.createNewQuestion(javaBeginner, "Q 4 - What is synchronization?", Question.QuestionType.MULTIPLE_CHOICE, 5);
		...
		Question javaBq5 = questionService.createNewQuestion(javaBeginner, "Q 5 - This is the parent of Error and Exception classes.", Question.QuestionType.MULTIPLE_CHOICE, 5);
		...
		Question javaBq6 = questionService.createNewQuestion(javaBeginner, "Q 6 - Inheritance", Question.QuestionType.MULTIPLE_CHOICE, 5);
		...
		Question javaBq7 = questionService.createNewQuestion(javaBeginner, "Q 7 - The thread may be in", Question.QuestionType.MULTIPLE_CHOICE, 5);
		...
		Question javaBq8 = questionService.createNewQuestion(javaBeginner, "Q 8 - The correct statement from the following is/are", Question.QuestionType.MULTIPLE_CHOICE, 5);
		...
		Question javaBq9 = questionService.createNewQuestion(javaBeginner, "Q 9 - The methods wait ( ) and notify ( ) are defined in", Question.QuestionType.MULTIPLE_CHOICE, 5);
		...
		Question javaBq10 = questionService.createNewQuestion(javaBeginner, "Q 10 - For the method that does not return a value, the keyword used is", Question.QuestionType.MULTIPLE_CHOICE, 5);
		...
		Question javaBq11 = questionService.createNewQuestion(javaBeginner, "Q 11 - Which one of the following is not a wrap class?", Question.QuestionType.MULTIPLE_CHOICE, 5);
		...
		Question javaBq12 = questionService.createNewQuestion(javaBeginner, "Q 12 - Object oriented programming language, is", Question.QuestionType.MULTIPLE_CHOICE, 5);
		...
		Question javaBq13 = questionService.createNewQuestion(javaBeginner, "Q 13 - ?: is: a/an", Question.QuestionType.MULTIPLE_CHOICE, 5);
		...
		Question javaBq14 = questionService.createNewQuestion(javaBeginner, "Q 14 - Which of the below is valid way to instantiate an array in java?", Question.QuestionType.MULTIPLE_CHOICE, 5);
